...
import { addInteraction, isArticleUsefulForUser, getUsefulCount, getInteractionsByArticle, removeInteraction } from '@/api/interactions'
...
export function UsefulButton({ articleId, onUpdate }: UsefulButtonProps) {
  ...
  const [isUseful, setIsUseful] = useState(isArticleUsefulForUser(articleId, currentUser.id))
