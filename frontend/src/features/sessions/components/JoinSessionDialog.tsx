          ...
          <>
            ...
            {showInfoDialog && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
                <div className="my-10 w-full rounded-lg bg-white px-6 pt-18 pb-14 shadow-lg">
                  ...
                  <form onSubmit={handleInfoSubmit} className="space-y-4">
                    ...
                    <div className="mt-5 flex gap-2">
                      <button
                        type="button"
                        className="text-b flex-1 rounded border py-1"
                        onClick={() => setShowInfoDialog(false)}>
                        キャンセル
                      </button>
                      <button
                        type="submit"
                        className="text-b flex-1 rounded bg-blue-600 py-1 text-white">
                        参加する
                      </button>
                    </div>
                  </form>
